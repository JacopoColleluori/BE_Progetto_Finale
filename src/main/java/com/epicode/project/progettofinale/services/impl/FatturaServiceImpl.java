...
public class FatturaServiceImpl implements FatturaService {
    ...
    public Page<FatturaDTORes> filterByStato(String stato) {
        List<Fattura> fatture = fatturaRepository.findByStatoNomeIgnoreCaseOrderByStatoNome(stato);
        if (fatture.isEmpty()) {
    ...
    public Page<FatturaDTORes> filterByData(LocalDate date) {
        List<Fattura> fatture = fatturaRepository.findByDataOrderByData(date);
        if (fatture.isEmpty()) {
    ...
    public Page<FatturaDTORes> filterByAnno(Integer anno) {
        List<Fattura> fatture = fatturaRepository.findByAnnoOrderByAnno(anno);
        if (fatture.isEmpty()) {
